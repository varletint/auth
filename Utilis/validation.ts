// Type definitions for validation inputs
...
export const validateProductInput = (data: ProductInput, isUpdate: boolean = false): string | null => {
...
export const validateSigninInput = (data: SigninInput): string | null => {
...
export const validateSignupInput = (data: SignupInput): string | null => {
    ...
    if (!phone_no || isNaN(Number(phone_no))) {
